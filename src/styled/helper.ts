...
export const padding = (top = 1, right?: number, bottom?: number, left?: number) => ({
    theme: {
        variables: { padding },
    },
}: Props): any =>
...
export const margin = (top = 0, right?: number, bottom?: number, left?: number) => ({
    theme: {
        variables: { margin },
    },
}: Props): any =>
...
export const boxShadow = (value?: number, color?: ColorsType) => (): any => css`
